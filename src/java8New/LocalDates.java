...
public class LocalDates
{
    ...
    public static void main(String[] args)
    {
        ...
        DateTimeFormatter dtimeFor = DateTimeFormatter.ofPattern("yyyyMMddHHMMSS");
        System.out.println(dtimeFor.format(localDateTime));
        LocalDateTime lDt = (LocalDateTime) dtimeFor.parse(dtimeFor.format(localDateTime));
